...
public class SoundRecorder extends Activity
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (hasAllPermissions()) {
            Log.i(TAG, "We got all needed permissions, good to go!");
            // Start Recording now
            recordButtonAction();
        } else {
            ...
            if (showMic || showStorage || showPhone) {
                ...
                // User is being really rude and wants to make this app useless
                Toast toast = Toast.makeText(SoundRecorder.this,
                              getString(R.string.error_toast), Toast.LENGTH_LONG);
                toast.show();
            }
        }
    }
