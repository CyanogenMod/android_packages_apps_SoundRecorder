...
public class SoundRecorder extends Activity
    ...
    public void onCreate(Bundle icycle) {
        ...
        registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                onBluetoothScoStateChanged(intent.getIntExtra(AudioManager.EXTRA_SCO_AUDIO_STATE, -1));
            }
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case START_RECORDING:
                        if (BLUETOOTH_RECORDING_ENABLED) {
                            if (mAudioSourceType == MediaRecorder.AudioSource.MIC && startBluetoothSco()) {
				...
				// when the connection is up
                    ...
                    case BLUETOOTH_SCO_MODE_TIMEDOUT:
                        ...
                        mBluetoothScoStarted = false;
                        mAudioManager.stopBluetoothSco();
                        Toast.makeText(SoundRecorder.this, R.string.bt_headset_timeout, Toast.LENGTH_SHORT).show();
                        break;
    ...
    private boolean startBluetoothSco() {
        ...
        mBluetoothConnectingToast = Toast.makeText(this, R.string.bt_headset_connecting, Toast.LENGTH_LONG);
    ...
    private void onBluetoothScoStateChanged(int state) {
        ...
        switch (state) {
            case AudioManager.SCO_AUDIO_STATE_DISCONNECTED:
                if (mBluetoothScoState == AudioManager.SCO_AUDIO_STATE_CONNECTED && mBluetoothScoStarted) {
                    Toast.makeText(this, R.string.bt_headset_disconnected, Toast.LENGTH_LONG).show();
                    mRecordHandler.sendEmptyMessage(STOP);
                }
                break;
